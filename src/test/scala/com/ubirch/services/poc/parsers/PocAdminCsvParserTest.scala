...
class PocAdminCsvParserTest extends TestBase {
  ...
  private val validCsv =
    s"""$pocAdminHeaderLine
       |${pocId.toString};$pocTypeValue;pocName;pocStreet;101;;12636;Wunschstadt;Wunschkreis;Wunschland;Deutschland;+591 74339296;TRUE;http://www.ubirch.com/logo.jpg;TRUE;certification-vaccination;Musterfrau;Frau;frau.musterfrau@mail.de;+591 74339296;{"vaccines":["vaccine1: vaccine2"]};Mustermann;Herr;herr.mustermann@mail.de;+591 74339296;01.01.1971;FALSE
       |""".stripMargin

  private val validHeaderButBadCsvRows =
    s"""$pocAdminHeaderLine
       |${pocId.toString};$pocTypeValue;pocName;pocStreet;101;;12636;Wunschstadt;Wunschkreis;Wunschland;Deutschland;+591 74339296;true;http://www.ubirch.com/logo.jpg;true;certification-vaccination;Musterfrau;Frau;frau.musterfrau@mail.de;+591 74339296;{"vaccines":["vaccine1: vaccine2"]};;Herr;herr.mustermann@;+591 74339296;01.01.1971;xfalse
       |${pocId.toString};$pocTypeValue;pocName;pocStreet;101;;;Wunschstadt;Wunschkreis;Wunschland;Deutschland;+591 74339296;true;http://www.ubirch.com/logo.jpg;true;certification-vaccination;Musterfrau;Frau;frau.musterfrau@mail.de;591 74339296;{"vaccines":["vaccine1: vaccine2"]};Mustermann;Herr;herr.mustermann@mail.de;591 74339296;01.1971;TRUE
       |${pocId.toString};$pocTypeValue;pocName;pocStreet;101;;12636;Wunschstadt;Wunschkreis;Wunschland;Deutschland;+591 74339296;true;http://www.ubirch.com/logo.jpg;true;certification-vaccination;Musterfrau;Frau;frau.musterfrau@mail.de;+591 74339296;{"vaccines":["vaccine1: vaccine2"]};Mustermann;Herr;herr.mustermann@mail.de;+591 74339296;01.01.1971
  ...
  "PocAdminCsvParser" should {
    ...
    "return invalid csvRows with errorMsg and validCsvRow as Poc" in {
      ...
      assert(result.head.left.get == s"""${pocId.toString};$pocTypeValue;pocName;pocStreet;101;;12636;Wunschstadt;Wunschkreis;Wunschland;Deutschland;+591 74339296;true;http://www.ubirch.com/logo.jpg;true;certification-vaccination;Musterfrau;Frau;frau.musterfrau@mail.de;+591 74339296;{"vaccines":["vaccine1: vaccine2"]};;Herr;herr.mustermann@;+591 74339296;01.01.1971;xfalse;column technician_surname* cannot be empty,column technician_email* must contain a proper mail address,column web_ident_required* must be either 'TRUE' or 'FALSE'""")
      assert(result(
        1).left.get == s"""${pocId.toString};$pocTypeValue;pocName;pocStreet;101;;;Wunschstadt;Wunschkreis;Wunschland;Deutschland;+591 74339296;true;http://www.ubirch.com/logo.jpg;true;certification-vaccination;Musterfrau;Frau;frau.musterfrau@mail.de;591 74339296;{"vaccines":["vaccine1: vaccine2"]};Mustermann;Herr;herr.mustermann@mail.de;591 74339296;01.1971;TRUE;column technician_mobile_phone* must contain a valid phone number e.g. +46-498-313789,column technician_date_of_birth* must contain a valid date e.g. 01.01.1970,column zipcode* must have the length of 5 digits,column manager_mobile_phone* must contain a valid phone number e.g. +46-498-313789""")
      assert(result(2).left.get ==
        s"""${pocId.toString};$pocTypeValue;pocName;pocStreet;101;;12636;Wunschstadt;Wunschkreis;Wunschland;Deutschland;+591 74339296;true;http://www.ubirch.com/logo.jpg;true;certification-vaccination;Musterfrau;Frau;frau.musterfrau@mail.de;+591 74339296;{"vaccines":["vaccine1: vaccine2"]};Mustermann;Herr;herr.mustermann@mail.de;+591 74339296;01.01.1971;the number of columns 26 is invalid. should be 27.""")
