...
class PocAdminCsvParserTest extends TestBase {
  ...
  "PocAdminCsvParser" should {
    ...
    "return invalid csvRows with errorMsg and validCsvRow as Poc" in {
      ...
      assert(result(
        1).left.get == s"""${pocId.toString};$pocTypeValue;pocName;pocStreet;101;;12636;Wunschstadt;Wunschkreis;Wunschland;Deutschland;+591 74339296;true;http://www.ubirch.com/logo.jpg;true;certification-vaccination;Musterfrau;Frau;frau.musterfrau@mail.de;+591 74339296;{"vaccines":["vaccine1: vaccine2"]};Mustermann;Herr;herr.mustermann@mail.de;+591 74339296;01.1971;TRUE;column technician_date_of_birth* must contain a valid date e.g. 01.01.1970""")
